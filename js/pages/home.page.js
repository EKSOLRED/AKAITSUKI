    ...
    <section class="page home-page" data-page="home">
      <section class="hero glass">
        <div>
          ...
          <p class="hero__subtitle">Удобный просмотр тайтлов, локальная авторизация для разработки, избранное по пользователям и архитектура, готовая к переходу на Supabase.</p>
          <div class="hero__stats">
            ...
            <div class="stat-card"><strong>${getDb().users.length}</strong><span>локальных пользователей</span></div>
          </div>
        </div>
        <aside class="hero__panel glass">
          <h2>Что уже есть</h2>
          <p>Локальный MVP для разработки без Supabase, но со слоистой архитектурой под backend.</p>
          <ul>
            <li>Каталог + поиск + фильтры</li>
            <li>Избранное по пользователю</li>
            <li>Аниме и сериалы в одной структуре</li>
            <li>Подготовка к Supabase без переписывания UI</li>
          </ul>
