import { sanitizeIframeSrc } from '../utils/text.utils.js';
    ...
    <div class="detail-player-layout detail-player-layout--wide">
      <section class="detail-player glass-soft">
        ...
        <div class="player-frame-wrap">
          ${player?.url
            ? `<iframe class="player-frame" src="${sanitizeIframeSrc(player.url)}" title="Плеер ${escapeHtml(item.title)}" allowfullscreen loading="lazy" referrerpolicy="strict-origin-when-cross-origin"></iframe>`
